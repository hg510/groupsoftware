    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('habit_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response_requests', to='adminpage.habitrequest', verbose_name='Habit Request')),
            ],
            options={
